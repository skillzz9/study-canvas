...
// ---------------------------------------------------------------------- //
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-paper p-6 font-space">
      ...
      <Link 
  href="/gallery"
  className="absolute top-6 left-[88px] p-3 bg-white border-4 border-neutral-800 rounded-xl shadow-[4px_4px_0px_0px_rgba(61,61,61,1)] hover:shadow-[2px_2px_0px_0px_rgba(61,61,61,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all text-neutral-800"
>
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
